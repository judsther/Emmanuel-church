      ...
      <section className="w-screen overflow-y-hidden h-auto bg-neutral-100 md:p-10">
        <div className="flex flex-col md:flex-row gap-10 items-center justify-center text-center pb-12">
          ...
          <div className="text-[12pt] text-neutral-600 flex flex-col items-start justify-center gap-3">
            ...
            <a
              href="https://www.facebook.com/IGLESIAEMANUELMCA"
              target="_blank"
              rel="noopener noreferrer"
              className="hover:text-blue-500 flex flex-row items-center"
            >
              <i className="bi bi-facebook text-amber-400 "></i>
              <p className="pl-2 text-[12pt] underline">
                Misión Centroamericana &quot;Emanuel&quot;
              </p>
            </a>
            <a
              href="mailto:mcasanvicente@gmail.com"
              className="flex items-center justify-center space-x-2 hover:text-white"
            >
              <i className="bi bi-envelope-fill text-amber-400"></i>
              <span className="underline">mcasanvicente@gmail.com</span>
            </a>
          </div>
        </div>
      </section>
