...
<Mapa />
      ...
      <section className="w-screen h-auto md:h-[550px] bg-neutral-800">
        ...
        <div className="flex items-center justify-center md:w-1/2 md:p-28 p-4">
          <img className=" rounded-2xl object-cover" src="https://res.cloudinary.com/djsdqleik/image/upload/v1742424189/481338681_3380605122073969_5022854454823692543_n_acxnss.jpg" alt="foto de iglesia emanuel mca de los primeros años" />
        </div>
...
{images.map((img, index) => (
  ...
  <div className=" h-full w-full">
       <img src={img.src} alt="" className="w-full h-64 object-contain overflow-x-auto" />
  </div>
</div>
))}
</div>
