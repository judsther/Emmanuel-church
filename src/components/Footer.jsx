  ...
  return (
    <footer className="bg-zinc-800 text-gray-400 py-8 overflow-y-hidden">
      <div className="max-w-7xl mx-auto px-6 text-center">
        <p className="text-lg font-semibold text-zinc-400">Emanuel M.C.A.</p>
        ...
        <div className="mt-4 flex flex-col md:flex-row items-center justify-center text-start space-x-6 gap-4">
          ...
          >
            ...
            <span>mcasanvicente@gmail.com</span>
          </a>
        ...
        <div className="mt-4 text-sm">
          &copy; {new Date().getFullYear()} Emanuel MCA. Todos los derechos
          reservados.
        </div>
      </div>
    </footer>
